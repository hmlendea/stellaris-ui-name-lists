...
build "ui_extra_humans_slavic"          "Human - Slavic"        "L" human/bulgarian human/russian human/slavic human/ukrainian
...
build "ui_extra_humans_extended"        "Human - Extended"      "L" \
      ...
      human/persian human/portuguese human/roman human/romanian human/russian human/slavic human/spanish human/turkic human/ukrainian human/common \
