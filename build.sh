...
build "ui_extra_humans_english"         "Human - English"       "L" human/australian human/english
...
build "ui_extra_humans_extended"        "Human - Extended"      "L" \
      human/afghan human/african human/arabic human/argentinian human/armenian human/australian human/austronesian human/baltic human/brazilian \
